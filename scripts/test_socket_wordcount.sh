...
show_instructions() {
    ...
    echo "   mvn compile exec:java -Dexec.mainClass=\"cn.demo.SocketWordCount\" -Dexec.args=\"localhost 9999\""
    echo ""
    echo "   或者运行窗口版本（每5秒统计一次）："
    echo "   mvn compile exec:java -Dexec.mainClass=\"cn.demo.SocketWindowWordCount\" -Dexec.args=\"localhost 9999\""
    echo ""
